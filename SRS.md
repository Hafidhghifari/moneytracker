...
Sistem dibuat untuk:
    ...
    Membantu mahasiswa mencatat pemasukan dan pengeluaran.
    Menampilkan kondisi keuangan pengguna secara sederhana.
    Menyimpan riwayat transaksi pengguna.
    Membatasi akses data berdasarkan akun pengguna.
    Menyediakan autentikasi menggunakan email dan password.
    Mempertahankan informasi autentikasi pengguna selama session masih berlaku.
    Menyediakan preferensi pengguna yang dapat disimpan.
    Memudahkan pengguna menambah dan menghapus transaksi.
...
Ketentuan:
    ...
    Sistem menyimpan data akun setelah proses register berhasil.
    Sistem menolak pendaftaran jika email sudah digunakan.
...
Aturan:
    ...
    Pengguna hanya dapat menambahkan transaksi ke akunnya sendiri.
    Pengguna hanya dapat menghapus transaksi miliknya sendiri.
    Pengguna tidak dapat mengakses transaksi milik pengguna lain dengan memanipulasi URL atau request.
    Halaman yang membutuhkan login tidak dapat diakses oleh pengguna yang belum login.
...
Sistem harus:
    ...
    Memvalidasi data.
    Menghubungkan transaksi dengan user yang sedang login.
    Menyimpan transaksi ke database.
    Menampilkan transaksi setelah berhasil disimpan.
...
Ketika logout:
    ...
    Session pengguna harus dihapus/dinyatakan tidak berlaku.
    Pengguna diarahkan ke halaman login.
    Pengguna tidak dapat mengakses halaman yang membutuhkan autentikasi tanpa login kembali.
